...
type AccessControl struct {
	...
	OpenAuth          string `json:"service_name" gorm:"column:service_name" description:"Service name."`
	BlackList         string `json:"service_desc" gorm:"column:service_desc" description:"Service description."`
	...
	ClientIPFlowLimit string `json:"clientip_flow_limit" gorm:"column:clientip_flow_limit" description:"Service description."`
	ServiceFlowLimit  string `json:"service_flow_limit" gorm:"column:service_flow_limit" description:"Service description."`
}
